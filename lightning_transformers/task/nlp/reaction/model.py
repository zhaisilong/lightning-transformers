...
class ReactionTransformer(Seq2SeqTransformer):
    ...
    def compute_generate_metrics(self, batch, prefix):
        ...
        result = self.acc(pred_lns, tgt_lns)
        self.log(f"{prefix}_accuracy", result, on_step=False, on_epoch=True, prog_bar=True)
